...
public class BremsStochastic extends Bremsstrahlung{
    ...
    public BremsStochastic(Bremsstrahlung cros){
	super(cros);
	int i;
	...
	return cros.cb*brems.Sel(v, cros.component);
    }
	...
	Output.err.println("Error (in BremsStochastic/e): sum was not initialized correctly");
	return 0;
    }
