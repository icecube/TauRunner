...
public class EpairStochastic extends Epairproduction{
	...
	return cros.ce*epair.ePair(v, cros.component);
    }
	...
	Output.err.println("Error (in EpairStochastic/e): sum was not initialized correctly");
	return 0;
    }
