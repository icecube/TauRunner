...
def Propagate(particle: Particle, track: Track, body: Body, e_cut=0) -> Particle:
    r'''
    ...
    while(not (particle.position >= 1. or  particle.survived==False or particle.energy <= e_cut)):
